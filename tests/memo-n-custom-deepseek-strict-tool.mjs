...
assert(loader.includes("const RUNTIME_VERSION = '0.54-adjacent-comment-guard-1'"), 'loader运行时版本不是0.54注释边界兼容版');
assert(loader.includes("const DISPLAY_VERSION = '0.54'"), 'loader显示版本不是0.54');
...
assert(manifest.version === '0.54', 'manifest版本不是0.54');
