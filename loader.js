const RUNTIME_VERSION = '0.49-cultivation-hierarchy';
const DISPLAY_VERSION = '0.49';
...
console.log('[Memo-N][loader] v0.49 loaded: cultivator umbrella/specialty hierarchy aligned');
