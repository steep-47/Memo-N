const RUNTIME_VERSION = '0.48-cultivation-path-labels';
const DISPLAY_VERSION = '0.48';
...
console.log('[Memo-N][loader] v0.48 loaded: cultivation path uses normalized practitioner/route labels');
