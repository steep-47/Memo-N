...
const RUNTIME_VERSION = 'memon76';
const PUBLIC_VERSION = '0.1.0-memon.76';
...
// - 老用户旧 step_by_step 只在新模式字段首次不存在时迁移一次，之后旧字段仅作运行时瞬时标志。
...
console.log('[Memo-N][loader] memon76 模式迁移与全记录入口手动协议版加载完成');