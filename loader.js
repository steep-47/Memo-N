...
//   DeepSeek直连/NATIVE走JSON信封；SillyTavern自定义(OpenAI兼容)与反代端点直接走原生tableEdit。
// - 中转站不再使用额外哨兵和响应转换桥，避免事件顺序竞态与重复协议。
// - Provider路由不保留含糊的CUSTOM中间态，避免中转站被误送入JSON协议。
...
console.log('[Memo-N][loader] memon63 中转直接tableEdit版加载完成');