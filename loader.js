const RUNTIME_VERSION = '0.26-appearance-light-refine';
const DISPLAY_VERSION = '0.26';
...
console.log('[Memo-N][loader] v0.26 appearance light refinement runtime loaded');
