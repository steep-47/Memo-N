...
const RUNTIME_VERSION = 'memon85';
const PUBLIC_VERSION = '0.1.0-memon.85';
...
// - 伊依直接角色与预设桥共享独立长期记忆库；中转普通回复顺序固定为前置tableEdit→正文→正文末尾yiyiMemory；记忆写回在记录持久化后串行执行，避免重复处理。
...
console.log('[Memo-N][loader] memon85 完整运行面与伊依串行持久化修复版加载完成');