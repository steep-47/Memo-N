...
import { TableTwoStepSummary } from "./scripts/runtime/separateTableUpdate.js?v=memon4";
...
import { initRefreshTypeSelector } from './scripts/runtime/absoluteRefresh.js?v=memon4';
...
import { executeMemoTableEdit, restoreMemoSnapshot } from './scripts/runtime/safeTableExecutor.js?v=memon4';
import { getMemoTableEditChannel } from './scripts/runtime/memoResponseChannels.js?v=memon4';
import { initExternalDataAdapter } from './external-data-adapter.js';


console.log("______________________记忆插件：开始加载______________________")

const VERSION = '0.1.0-memon.4'
