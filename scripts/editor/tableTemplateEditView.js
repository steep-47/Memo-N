...
function initChatScopeSelectedSheets() {
    ...
    USER.getContext().chatMetadata.memo_n_selected_sheets = newSelectedSheets
...
function getSelectedSheetUids() {
    return scope === 'chat' ? USER.getContext().chatMetadata.memo_n_selected_sheets ?? initChatScopeSelectedSheets() : USER.getSettings().memo_n_table_selected_sheets ?? []
}

function setSelectedSheetUids(selectedSheets) {
    if (scope === 'chat') {
        USER.getContext().chatMetadata.memo_n_selected_sheets = selectedSheets;
    } else {
        USER.getSettings().memo_n_table_selected_sheets = selectedSheets;
    }
