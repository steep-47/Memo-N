...
function coordinateRelayPrompt(data) {
    ...
    console.log(`[Memo-N] 中转站提示已协调：正文末尾tableEdit｜tablePrompt=${rewritten}｜recordContract=${contracts}｜source=${endpoint.source || 'unknown'}｜customUrl=${endpoint.customUrl}｜reverseProxy=${endpoint.reverseProxy}`);
}
...
console.log('[Memo-N] 中转站提示协调器已加载：完整正文后追加tableEdit；不改写user消息');
