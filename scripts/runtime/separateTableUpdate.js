...
记录前先把正文拆成最小独立事实再逐项归位。“修炼体系/路径”只保存稳定的修行类别或专精路线标签，不写解释句。人族走灵根→法力→常规修仙机制且没有明确专精时统一记“练气士”；练气士是修仙统称，不随炼气/筑基/金丹等境界变化，会普通功法术法也仍只是练气士。若已经明确形成剑修、法修、魂修、丹师、器师、符师、阵师、御兽、旁门等稳定专精/职业，直接记录更具体标签并取代“练气士”，不得写“练气士／剑修”；多个具体专精只有在都明确时才用“／”连接。武夫和体修均区别于常规练气士修仙，且武夫≠体修，不得与练气士组合。妖族实际修行记“妖修”，灵族达到自主修行并实际修炼记“灵修”。不得只凭种族、一次用剑、一次施法、一次炼丹等行为判定路线。“修为”只写当前境界/阶段；修炼经历、长期停滞、瓶颈、伤势或限制分别写人物主表重要信息或人物发展表当前重要状态，不塞进体系/路径或修为字段。
只能使用：
