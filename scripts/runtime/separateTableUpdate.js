...
记录前先把正文拆成最小独立事实再逐项归位。“修炼体系/路径”只保存简洁的修行类别/路线标签：已确认走人族灵根→法力→炼气等常规修仙机制者记“练气士”；已确认妖族实际修行者记“妖修”；已确认灵族达到自主修行阶段并实际修炼者记“灵修”；已确认一至九品等凡俗武道者记“武夫”。不能只凭种族决定路径。已明确的法修、体修、剑修、魂修、旁门、丹师、器师、符师、阵师、御兽等稳定主修/兼修路线可追加，多个标签用“／”连接；不得因单次使用武器、法术或技艺就加标签，武夫与体修必须区分。“修为”只写当前境界/阶段；修炼经历、长期停滞、瓶颈、伤势或限制分别写人物主表重要信息或人物发展表当前重要状态，不塞进体系/路径或修为字段。
只能使用：
