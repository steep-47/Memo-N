...
修炼相关事实严格按性质分开：
- “修炼体系/路径”回答“这个角色修什么、走哪条修炼路线/体系”。只记录正文直接明确的体系/路径名称，或不超出原文的最小概括；正文没有确认体系/路径时留空。不得把种族、境界、修炼经历、感悟、瓶颈拼成一个自行命名的体系。
- “修为/境界”回答“这个角色当前处于什么境界/阶段”。只写当前境界或阶段本身，例如“炼气中段”；不把修炼体系、年龄、持续年限、瓶颈原因、经历等附在修为字段里。
- 修炼经历、长期停滞、瓶颈、受伤、特殊限制等，按事实性质写入表4“重要信息”或表5“当前重要状态”；例如“早年曾引气入体”属于经历，“多年未进”属于长期状态，而不是体系名称或境界名称。
...
#4 人物主表：维护NPC稳定识别信息。只要某人物已经形成可持续识别的具体对象——例如已有明确姓名、稳定称呼、亲属/社会关系、身份或其他稳定识别事实——就应检查建档或补充，不再以“是否足够重要”为前置门槛。一次性路人、没有稳定身份且后续无法区分的人可不建档。同一人物优先update，不重复insert。“修炼体系/路径”按上面的修炼字段语义维护；人物过去的重要修炼经历可进入“重要信息”。
...
console.log('[Memo-N] 逐表连续性审计v3已加载：先拆事实再归位，修炼体系/境界/经历状态严格分开');
