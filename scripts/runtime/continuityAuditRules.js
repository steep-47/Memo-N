...
#4 人物主表：维护NPC稳定识别信息。只要某人物已经形成可持续识别的具体对象——例如已有明确姓名、稳定称呼、亲属/社会关系、身份或其他稳定识别事实——就应检查建档或补充，不再以“是否足够重要”为前置门槛。一次性路人、没有稳定身份且后续无法区分的人可不建档。同一人物优先update，不重复insert。“修炼体系/路径”按上面的规范化类别/专精语义维护；人物过去的重要修炼经历可进入“重要信息”。
