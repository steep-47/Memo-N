...
import { repairMissingColumnsBeforeCleanup } from './tableStructureRepair.js?v=memon2';
import { ensureSevenTableWorld } from './sevenTableMigration.js?v=memon2';
import { executeMemoTableEdit, parseMemoTableEdit } from './safeTableExecutor.js?v=memon2';
