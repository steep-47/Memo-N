...
const PROMPT_MARKER = '[Memo-N YiYi memory runtime v6]';
...
console.log('[Memo-N][伊依] 自动记忆v6已加载：插件只负责记忆读取/写回/事务，不定义伊依人格或表达模板');
